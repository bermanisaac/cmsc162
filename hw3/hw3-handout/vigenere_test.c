...
int main(void) {
    ...
    word_t dummy_key[5];
    dummy_key[0] = (word_t)"a";
    dummy_key[1] = (word_t)"a";
    dummy_key[2] = (word_t)"a";
    dummy_key[3] = (word_t)"a";
    dummy_key[4] = (word_t)"a";
